...
class Conjugation(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    verb_id = db.Column(db.Integer, db.ForeignKey('irregular_verb.id'),
                        nullable=False)
    ...
    present_participle = db.Column(db.String, nullable=True)
    past_participle = db.Column(db.String, nullable=True)
